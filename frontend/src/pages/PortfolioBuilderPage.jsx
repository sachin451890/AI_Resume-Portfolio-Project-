      ...
      {!isSubscribed ? (
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
          ...
          <div className="lg:col-span-4 p-6 overflow-y-auto max-h-[calc(100vh-65px)] border-r border-slate-800 space-y-6">
            ...
            {/* AI Resume to Portfolio Converter Section */}
            <div className="p-4 rounded-2xl bg-gradient-to-r from-purple-950/80 to-slate-900 border border-purple-500/40 space-y-3">
              <div className="flex items-center gap-2 text-xs font-bold text-purple-300">
                <Sparkles className="w-4 h-4 text-purple-400" />
                <span>AI Portfolio Website Generator</span>
              </div>
              <p className="text-[11px] text-slate-300 leading-relaxed">
                Automatically convert your resume data into an animated 3D motion portfolio website structure.
              </p>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold text-xs shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 transition"
              >
